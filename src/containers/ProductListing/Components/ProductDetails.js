...
import { getAllDocs } from '../../../data/firbaseCalls'
...
export default function ProductDetails() {
  ...
  console.log(return_window)
  console.log(time_to_ship)
  const productDeatailsViewData = [
    {
  ...
  return (
    <Fragment>
      <div>
        ...
        <div>
          <div className={styles.products_header_view}>
            <p>{`Products from ${provider_name}`}</p>
          </div>
          <div className={styles.same_provider_product_view}>
            {sameProviderProducts.map((product) => {
              return (
                <div key={product?.id}>
