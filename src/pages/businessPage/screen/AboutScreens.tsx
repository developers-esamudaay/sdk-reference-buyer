...
type AboutProps={
  ...
  const AboutScreen:React.FC<AboutProps> = ({providerLocation,sellerPrettyAddress,businessDetails})=>(
          ...
          <div className="col-lg-6 col-xl-7 col-md-6 col-sm-12">
            <div className={styles.address_contact_container}>
              ...
              <div className={styles.address_content}>
                <p className={styles.business_name}>{businessDetails?.business_name}</p>
              ...
              <div className={styles.business_details}>
                ...
                <div className={styles.address_content}>
                  <p className={styles.address_text}>{`bppid:${businessDetails?.bpp_id}`}</p>
                  <p className={styles.address_text}>{`bppUrl:${businessDetails?.bpp_uri}`}</p>
                  <p
